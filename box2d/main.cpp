...
int main() {
    ...
    Flag flag(&world, 850.0f, 630.0f, 100.0f, 100.0f, "assets/Images/flag.png");
    ...
    //create Moving Collider
    MovingColliders collider(world, sf::Vector2f(2.0f, 15.0f), sf::Vector2f(5.0f, 0.0f), 1.0f, true, false);
